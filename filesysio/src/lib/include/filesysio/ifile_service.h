...
class IFileService
{
 public:
   ...
   virtual RwError read(const std::filesystem::path& path, ReadCallback readCallback) = 0;
   virtual RwError write(const std::filesystem::path& path, WriteCallback writeCallback) = 0;
